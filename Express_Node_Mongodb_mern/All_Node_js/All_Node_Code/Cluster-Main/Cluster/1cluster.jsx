Yes! In Node.js, the cluster module is used to take 
advantage of multi-core CPUs.
By default, Node.js runs on a single thread, so a
single process cannot fully utilize
all CPU cores. cluster allows you to create multiple
worker processes that share the same server port.
...
“Node.js cluster allows multi-core utilization by 
forking multiple worker processes from a master, each
 listening on the same port, providing load balancing
