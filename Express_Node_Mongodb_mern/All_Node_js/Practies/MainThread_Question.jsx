...
“Single-threaded” describes how Node.js is designed,
while “Main thread” is the actual thread doing that single-threaded work.
...
Node.js starts one main thread → runs JavaScript using the Event Loop.


For operations like File I/O, Crypto, or Compression, Node uses a 
