...
So, if a CPU has 4 cores, it can run up to 4 threads truly in parallel (or more with hyper-threading).

🧠 2️⃣ What Does “Single Thread” Mean in Node.js?
✅ Meaning:

Node.js executes JavaScript code in one main thread only — the Event Loop Thread.
...
A thread pool is a group of pre-initialized worker threads that can perform background tasks without blocking the main thread.
...
if (isMainThread) {
  ...
  new Worker(__filename); // create a new thread
} else {
