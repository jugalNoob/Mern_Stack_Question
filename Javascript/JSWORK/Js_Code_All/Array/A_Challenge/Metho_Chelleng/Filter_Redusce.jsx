...
Not because null is “not a boolean”

👉 Everything in JavaScript is converted to boolean in conditions.
...
filter(Boolean) removes ALL falsy values — not just false.
❗ If you want to remove ONLY null and undefined
const clean = arr.filter(v => v != null);
Keeps 0, "", false ✅
❗ If you want to remove ONLY empty strings
arr.filter(v => v !== "");
🏆 One-Line Interview Answer
null is removed because it is a falsy value and
