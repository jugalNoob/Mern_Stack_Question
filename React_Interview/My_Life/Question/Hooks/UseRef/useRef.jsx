...
Refs are mutable containers: great for values you want to persist across renders without triggering render

State changes are what tell React to re-render
...
useRef stores a mutable value that persists across renders, but changing it does not trigger a component re-render — only state or props 
